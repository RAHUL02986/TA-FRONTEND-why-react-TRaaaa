          ...
          <div className="flex wrap">
            <article className="flex article flex-48">
              ...
              <div className="flex-60 article-content">
                ...
                <a className="btn btn-tertiary" href="article.html">
                  Read Article
                </a>
              </div>
            </article>
            <article className="flex article flex-48">
              ...
              <div className="flex-60 article-content">
                ...
                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit.</p>
                <a className="btn btn-tertiary" href="todo.html">
                  Read More
                </a>
              </div>
            </article>
            <article className="flex article flex-48">
              ...
              <div className="flex-60 article-content">
                ...
                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit.</p>
                <a className="btn btn-tertiary" href="blog.html">
                  Read Article
                </a>
              </div>
            </article>
            <article className="flex article flex-48">
              ...
              <div className="flex-60 article-content">
                ...
                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit.</p>
                <a className="btn btn-tertiary" href="index.js">
                  View Detail
                </a>
              </div>
            </article>
